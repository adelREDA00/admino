...
export default function AddingPage() {
  ...
  const { data1, loading1, error1, reFetch } = useFetch("https://apiblognode.onrender.com/api/league/", token);
  ...
  const handleDelete = async () => {
    try {
      const res = await axios.delete(`https://apiblognode.onrender.com/api/league/${currentId}`, {
        headers: {
  ...
  const handleAddObj = async (inputValue, file, data) => {
    ...
    try {
      const res = await axios.post(
        "https://apiblognode.onrender.com/api/league",
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get(`https://apiblognode.onrender.com/api/football/leagues?api_token=${API} `);
  ...
  const handleDeleteall = async () => {
    try {
      ...
      const res = await axios.delete("https://apiblognode.onrender.com/api/league", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleEditopen = async () => {
    ...
    const handleEdit = async (name) => {
      try {
        ...
        const response = await axios.put(`https://apiblognode.onrender.com/api/league/${currentId}`, updatedCategory, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
